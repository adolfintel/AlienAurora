...
function FD23(target,config){
    ...
    this._target=target;
    if(target.fd23instance){
        target.fd23instance.destroy();
    }
    target.fd23instance=this;
    ...
    this.targetSpeed=assignOrDefault(config.targetSpeed,1);
...
FD23.prototype={
    ...
    destroy:function(){
        ...
        this._target.fd23instance=null;
    }
}
